  ...
  if (xcp->kstack != NULL)
    {
       ...
       *
       * It also has to be out of the user stack for fork():  a child that
       * inherits the parent's stack address (CONFIG_ARCH_FORK_STACK_INHERIT)
       * would otherwise have this frame carved out of the very frames it is
