  ...
  if (xcp->kstack != NULL)
    {
       ...
       *
       * It also has to be out of the user stack for fork(): the child's
       * user stack is a copy of the parent's, so carving a register frame
       * out of the top of it would overwrite part of what was copied.
       */
