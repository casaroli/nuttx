...
$(BOOTLOADER_CONFIG): $(TOPDIR)/.config $(BOOTLOADER_DIR)
	...
	$(Q) { \
		...
		$(if $(CONFIG_ESP32S3_FLASH_MODE_OCT),$(call cfg_en,CONFIG_ESPTOOLPY_OCT_FLASH)) \
		$(if $(CONFIG_ESP32S3_FLASH_MODE_OCT),$(call cfg_en,CONFIG_ESPTOOLPY_FLASHMODE_OPI)) \
		$(if $(CONFIG_ESP32S3_FLASH_SAMPLE_MODE_STR),$(call cfg_en,CONFIG_ESPTOOLPY_FLASH_SAMPLE_MODE_STR)) \
		$(if $(CONFIG_ESP32S3_FLASH_SAMPLE_MODE_DTR),$(call cfg_en,CONFIG_ESPTOOLPY_FLASH_SAMPLE_MODE_DTR)) \
