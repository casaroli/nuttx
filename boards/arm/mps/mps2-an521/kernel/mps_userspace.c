/****************************************************************************
 * boards/arm/mps/mps2-an521/kernel/mps_userspace.c
 *
...
#if CONFIG_NUTTX_USERSPACE != 0x10200000
#  error "CONFIG_NUTTX_USERSPACE must be 0x10200000 to match memory.ld"
#endif
