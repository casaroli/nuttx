/****************************************************************************
 * boards/arm/rp23xx/pimoroni-pico-2-plus/kernel/rp23xx_userspace.c
 *
...
#if CONFIG_NUTTX_USERSPACE != 0x10100000
#  error "CONFIG_NUTTX_USERSPACE must be 0x10100000 to match memory.ld"
#endif
...
extern const uint8_t _eronly[];    /* End+1 of read only section */
