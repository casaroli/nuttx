...
{
#if defined (CONFIG_LCD_ST7789) || defined (CONFIG_LCD_ST7735) || \
    defined (CONFIG_LCD_GC9A01) || defined (CONFIG_LCD_ST7365P)
  if (devid == SPIDEV_DISPLAY(0))
    {
      ...
      rp23xx_gpio_put(CONFIG_RP23XX_SPI0_DC_GPIO, !cmd);
  ...
  if (devid == SPIDEV_DISPLAY(0))
    {
      ...
      rp23xx_gpio_put(CONFIG_RP23XX_SPI1_DC_GPIO, !cmd);
