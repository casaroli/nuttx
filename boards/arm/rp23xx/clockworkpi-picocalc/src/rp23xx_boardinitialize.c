/****************************************************************************
 * boards/arm/rp23xx/clockworkpi-picocalc/src/rp23xx_boardinitialize.c
 *
...
void rp23xx_boardearlyinitialize(void)
{
  ...
  /* Park the GPIOs nothing owns before any driver claims a pin.  On an
   * RP2350B this is worth milliamps -- see src/rp23xx_pinpark.c.
   */
