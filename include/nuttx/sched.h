 ...
 *    - Allocating the stack -- or borrowing the parent's, for vfork() on an
 *      architecture that selects CONFIG_ARCH_VFORK_STACK_BORROW
 ...
 * time the child is off the ready-to-run list and has stopped touching a
 * borrowed stack, and by which time an exec()ing child has already handed
 * its pid to the program it loaded.
 *
 ****************************************************************************/
